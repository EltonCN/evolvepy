...
if __name__ == "__main__":
    ...
    sizes = [10, 2] # Units of each layer
    ...
    logger = WandbLogger("3DBall", "EvolvePy Example")

    evolver = ep.Evolver(generator, multiple_evaluation, population_size, [dyn_mut, logger])


    hist, last_pop = evolver.evolve(20)
